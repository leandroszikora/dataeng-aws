...
(
    ...
    LOCATION 's3://data-engineering-aws/raw/medicalresearch/'
...
(
    ...
    STORED AS PARQUET
    LOCATION 's3://data-engineering-aws/stage/medicalresearch_curated/'
...
(
    ...
    PARTITIONED BY (dt_month INTEGER)
    STORED AS PARQUET
    LOCATION 's3://data-engineering-aws/analytics/medicalresearch_word_count/'
    TBLPROPERTIES ('parquet.compression' = 'SNAPPY', 'data_team' = 'dataeng', 'data_steward' = 'health_area');