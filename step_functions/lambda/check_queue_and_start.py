...
STATE_MACHINE_ARN = "arn:aws:states:us-east-1:864463453732:stateMachine:StageToAnalytics-SM"
    ...
    if len(messages_well) == len(required_files):
        ...
        response = {
            ...
            'body': {
                ...
                'job_name': job_name,
                'source': f"s3://data-engineering-aws/stage/pre-stage/{dataset}/{event_date}",
                'output': f"s3://data-engineering-aws/stage/post-stage/{dataset}/{event_date}",
